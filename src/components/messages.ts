export const labels: Record<string, string> = {
  ...
  twoFactorAuthentication: 'label.two-factor-authentication',
  twoFactorCode: 'label.two-factor-code',
  recoveryCode: 'label.recovery-code',
  recoveryCodes: 'label.recovery-codes',
  enableTwoFactor: 'label.enable-two-factor',
  disableTwoFactor: 'label.disable-two-factor',
  regenerateRecoveryCodes: 'label.regenerate-recovery-codes',
  copyCodes: 'label.copy-codes',
  copied: 'label.copied',
  iSavedRecoveryCodes: 'label.i-saved-recovery-codes',
  trustDevice30Days: 'label.trust-device-30-days',
  verify: 'label.verify',
  manualKey: 'label.manual-key',
};
...
export const messages: Record<string, string> = {
  ...
  twoFactorPrompt: 'message.two-factor-prompt',
  twoFactorSetupIntro: 'message.two-factor-setup-intro',
  twoFactorSetupStepScan: 'message.two-factor-setup-step-scan',
  twoFactorSetupStepVerify: 'message.two-factor-setup-step-verify',
  twoFactorSetupStepRecovery: 'message.two-factor-setup-step-recovery',
  twoFactorSetupPrompt: 'message.two-factor-setup-prompt',
  twoFactorRecoveryWarning: 'message.two-factor-recovery-warning',
  twoFactorRecoveryCopyFailed: 'message.two-factor-recovery-copy-failed',
  invalidTwoFactorCode: 'message.invalid-two-factor-code',
  expiredTwoFactorChallenge: 'message.expired-two-factor-challenge',
  twoFactorRequired: 'message.two-factor-required',
  invalidTwoFactorSetup: 'message.invalid-two-factor-setup',
  twoFactorAlreadyEnabled: 'message.two-factor-already-enabled',
  twoFactorNotEnabled: 'message.two-factor-not-enabled',
